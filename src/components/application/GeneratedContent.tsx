        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sys-spacing-xs)' }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 'var(--sys-radius-md)',
              border: 'none',
              backgroundColor: isCopied ? 'var(--sys-color-success)' : '#0F172A',
              color: 'white',
              fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer',
              transition: 'all 0.2s',
              minHeight: 36,
            ...
            return (
              <button
                ...
                style={{
                  ...
                  borderRadius: 'var(--sys-radius-md)',
                  border: 'none',
                  backgroundColor: activeTab === platform.id ? '#F1F5F9' : 'transparent',
                  color: activeTab === platform.id ? '#0F172A' : 'var(--sys-color-neutral-60)',
